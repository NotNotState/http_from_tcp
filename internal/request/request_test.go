...
func TestRequestLineParse(t *testing.T) {
	...
	reader = &chunkReader{
		data:            "HTTP/1.1 /coffee POST\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n",
		numBytesPerRead: 3,
	}
	_, err = RequestFromReader(reader)
	require.Error(t, err)

	// Test: Invalid Request-Line Version
	reader = &chunkReader{
...
func TestBodyParse(t *testing.T) {
	...
	// Test: length = 0 and no body (Valid)
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n" +
	...
	// Test: No length but body present (Valid in our case)
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n" +
